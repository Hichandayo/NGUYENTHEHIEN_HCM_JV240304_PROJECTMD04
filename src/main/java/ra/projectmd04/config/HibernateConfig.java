...
public class HibernateConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/projectmd04?createDatabaseIfNotExist=true");
        dataSource.setUsername("root");
        dataSource.setPassword("Aa0349811893");
        return dataSource;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("ra.projectmd04.model.entity");
